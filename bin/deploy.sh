...
# docker push 108961151232.dkr.ecr.us-east-2.amazonaws.com/minu/kafkadev:$(git rev-parse --short HEAD)
# docker push 108961151232.dkr.ecr.us-east-2.amazonaws.com/minu/kafkadev:latest
